...
public class MoveWords{
    ...
    public static int checkWinner(String first, String second){
	    ...
	    if (first_i == 0 && second_i==4) return PIERDE;
	    if (first_i == 1 && second_i==0) return PIERDE;
	    ...
	    if (first_i == 2 && second_i==1) return PIERDE;
	    ...
	    if (first_i == 3 && second_i==2) return PIERDE;
	    ...
	    if (first_i == 4 && second_i==3) { return PIERDE;}else {return PIERDE;}
	    
	 
	   
	    
	    
	   //return ((first_i+1 % validMoves.length) == second_i || (first_i +1 % validMoves.length) == second_i+3) ? GANA: PIERDE;
